"""
Django settings for albinstore project.
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1","malvin-rheinaldy-albinstoree.pbp.cs.ui.ac.id", "10.0.2.2"]
...
WSGI_APPLICATION = 'albinstore.wsgi.application'
